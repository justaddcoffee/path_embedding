...
gh-add-topics:
  gh repo edit --add-topic "path-embedding,monarchinitiative,linkml"
...
gh-invite-the-dragon:
  gh api repos/justaddcoffee/path-embedding/collaborators/dragon-ai-agent -X PUT -f permission=push

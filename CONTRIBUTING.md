# Contributing to path-embedding

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
path-embedding. These guidelines are not strict rules.
...
The path-embedding team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the path-embedding technical leads
...
[issues]: https://github.com/justaddcoffee/path-embedding/issues/
[pulls]: https://github.com/justaddcoffee/path-embedding/pulls/
